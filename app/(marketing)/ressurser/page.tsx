...
export const metadata: Metadata = pageMeta({
  title: 'Guider for tilbud, materialer og prosjektstyring',
  description: 'Praktiske Efero-guider for kalkulasjon, grossistpriser, tilbudsoppfølging og prosjektøkonomi i norske håndverksbedrifter.',
  path: '/ressurser',
  keywords: ['kalkulasjon håndverker', 'grossistpriser', 'tilbudsoppfølging', 'prosjektøkonomi håndverker'],
})

export default function ResourcesPage() {
  return <>
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema([{ name: 'Hjem', path: '/' }, { name: 'Ressurser', path: '/ressurser' }])) }} />
    <section className="max-w-site mx-auto px-6 md:px-10 py-20 md:py-24">
      ...
      <p className="mt-6 text-[18px] leading-[1.6] text-[#2f4a41] max-w-[52ch]">Se hvordan Efero løser de viktigste flytene fra prisgrunnlag og kalkulasjon til kundesvar, faktura og prosjektkontroll.</p>
