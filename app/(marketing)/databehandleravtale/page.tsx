  ...
  return (
    <main style={{ backgroundColor: '#ffffff', padding: '96px 24px' }}>
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <p style={{ color: '#3d5c52', fontSize: 15, marginBottom: 24 }}>
          Sist oppdatert: Juni 2026
        </p>
        <p style={{ color: '#3d5c52', fontSize: 16, lineHeight: 1.75, marginBottom: 56 }}>
        ...
        <Section heading="1. Partene">
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div style={{ padding: '16px 20px', backgroundColor: '#f5f7f5', borderRadius: 10, borderLeft: '3px solid #3d5c52' }}>
              <p style={{ fontWeight: 600, color: '#00281f', marginBottom: 4 }}>Behandlingsansvarlig</p>
              <p>Din virksomhet — registrert ved opprettelse av Efero-konto.</p>
            </div>
            <div style={{ padding: '16px 20px', backgroundColor: '#f5f7f5', borderRadius: 10, borderLeft: '3px solid #004c3a' }}>
              <p style={{ fontWeight: 600, color: '#00281f', marginBottom: 4 }}>Databehandler</p>
              <p>Efero</p>
        ...
        <Section heading="6. Underleverandører">
          ...
          <div style={{ border: '1px solid #d3ded8', borderRadius: 10, overflow: 'hidden', margin: '4px 0' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr 1fr', backgroundColor: '#f5f7f5', padding: '10px 16px' }}>
              <span style={{ color: '#00281f', fontWeight: 600, fontSize: 13 }}>Leverandør</span>
              <span style={{ color: '#00281f', fontWeight: 600, fontSize: 13 }}>Formål</span>
              <span style={{ color: '#00281f', fontWeight: 600, fontSize: 13 }}>Land</span>
            </div>
            {[
              ...
              <div key={row.name} style={{ display: 'grid', gridTemplateColumns: '1fr 2fr 1fr', padding: '12px 16px', backgroundColor: i % 2 === 0 ? '#ffffff' : '#f5f7f5', borderTop: '1px solid #d3ded8' }}>
                <span style={{ color: '#00281f', fontWeight: 600, fontSize: 14 }}>{row.name}</span>
                <span style={{ color: '#3d5c52', fontSize: 14 }}>{row.purpose}</span>
                <span style={{ color: '#3d5c52', fontSize: 14 }}>{row.country}</span>
              </div>
            ))}
          </div>
...
function SubHeading({ children }: { children: React.ReactNode }) {
  return (
    <p style={{ color: '#00281f', fontWeight: 600, fontSize: 15, marginTop: 4, marginBottom: 2 }}>
      {children}
    </p>
  )
}
